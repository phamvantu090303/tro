...
const UserResendForgot = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post('/auth/resend-forgot-password', { email }, {
      ...
      setIsError(true);
      setMessage(error.response?.data?.message || 'Đã xảy ra lỗi trong quá trình xử lý.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">Gửi lại email quên mật khẩu</h2>
