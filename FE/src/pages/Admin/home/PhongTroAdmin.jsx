    ...
    try {
      if (modal === "edit") {
        await axiosInstance.post(
          `/phongTro/update/${selectedAdmin.ma_phong}`,
          selectedAdmin
        );
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-1/4">
              <h2 className="text-xl font-semibold mb-4">
                {modal === "edit" ? "Edit Room" : "Create Room"}
              </h2>
              <button
              ...
              {filteredUsers.map((admin) => (
                <tr key={admin.ma_phong}>
                      ...
                      <td key={key} className="py-2 pl-3">
                        <Select
                          ...
                          onChange={async (value) => {
                            try {
                              await axiosInstance.post(
                                `/phongTro/update/${admin.ma_phong}`,
                                {
                                  ...admin,
                                  trang_thai: value,
                                }
                  ...
                  <td className="py-2 pl-3 flex gap-2">
                    ...
                    <button
                      onClick={() => handleDeletePhongTro(admin.ma_phong)}
