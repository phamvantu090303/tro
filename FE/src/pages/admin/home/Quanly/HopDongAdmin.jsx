...
function HopDongAdmin() {
    const { modalType, idModal, isOpen } = useSelector((state) => state.ModalForm);
    ...
    const { data: hopdong, UpdateData, DeleteData } = useApiManagerAdmin("/hopdong");
                        ...
                        <form className="space-y-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="yeu_cau_huy_hop_dong">Yêu cầu hủy hợp đồng</option>
                                </select>
                            </div>
