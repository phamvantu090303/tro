...
export const createSuaChua = async (req: Request, res: Response): Promise<Response> => {
    try {
        const {user}:any = req;
        const data = req.body;
...
export const updateSuaChua = async (req: Request, res: Response): Promise<Response> => {
    try {
        const { id } = req.params;
        const data = req.body;
...
export const deleteSuaChua = async (req: Request, res: Response): Promise<Response> => {
    try {
        const { id } = req.params;
...
export const GetSuaChuaById = async (req: Request, res: Response): Promise<Response> => {
    try {
        const {user}:any = req;
