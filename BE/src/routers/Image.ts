...
routeImage.get("/getAll",accessTokenAdmin,authorize("67b1dfa48631e4849450bbbf"), getAllImages);
routeImage.delete("/delete/all",accessTokenAdmin,authorize("67d8d6e5b2276a21455150e2"), deleteAllImages);
routeImage.delete("/delete/:id",accessTokenAdmin,authorize("67b1dfa48631e4849450bbbe"), deleteImageById);
